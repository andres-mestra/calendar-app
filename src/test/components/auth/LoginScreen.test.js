...
describe('Pruebas en <LoginScreen />', () => {
  ...
  test('debe de llamar el dispatch del login', () => {
    ...
    expect( startLogin ).toHaveBeenCalledWith('andres@mail.com','123456')

  })

  test('No hay registro si las contraseñas con diferentes.', () => {
  ...
  test('Registro con password iguales', () => {
    wrapper.find('input[name="rPassword1"]').simulate('change', {
      target: {
        name: 'rPassword1',
        value:'123456'
